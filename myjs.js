...
function toast(str){
	...
	popdiv.style.width = '250px';
	popdiv.style.padding = '30px 20px';
	popdiv.style.background = 'darksalmon';
	popdiv.style.position = 'absolute';
	popdiv.style.top = '25%';
	popdiv.style.left = '50%';
	popdiv.style.marginLeft = '-145px';
	popdiv.style.textAlign = 'center';
	popdiv.style.borderRadius = '8px';
	
	var poptext =document.createElement('p');
	poptext.innerHTML = str;
	poptext.style.width = '250px';
	console.log(str.length);
	poptext.style.fontSize = str.length>=15?'12px':'20px';
...
//			clearInterval(timer);
//		}
//		popdiv.style.width = oWidth +"px";
//	},20);
	setTimeout(function(){
		setInterval(function(){
			opc -= 0.1;
			popdiv.style.opacity = opc;	
		},100);
	},1000);
	setTimeout(function(){
		poptext.remove();
